							 ...
							 FLOAT fPosZ)
{
	...
	m_pItem->LoadUNIT( NULL, NULL, NULL, NULL, NULL, NULL, NULL, extmap.m_pDATA, nUnitZ * m_pItem->m_HugeMAP.m_nUnitCountX + nUnitX);
						   ...
						   DWORD dwUnitID)
{
	...
	if(!pUNIT->m_pDETAIL)
	{
		...
		memset( pUNIT->m_pDETAIL, 0xFF, sizeof(BYTE) * m_pItem->m_HugeMAP.m_nUnitLength * m_pItem->m_HugeMAP.m_nUnitLength);
	}
