...
void CTCashCabinetDlg::SetupComponent()
{
	...
	for( int i=0; i<m_nMaxItemSlot; ++i)
	{
								...
								DWORD dwBonusCash )
{
	...
	m_pCashPoints->m_strText.Format(m_pCashPoints->m_strText, dwCash);
	m_pBonusPoints->m_strText.Format(m_pBonusPoints->m_strText, dwBonusCash);
}
