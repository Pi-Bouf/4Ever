								  ...
								  DWORD dwTick)
{
	...
	if(CanFLY())
	{
		...
		fMinSKY = max( fHeight, fWaterHeight);
	...
	m_bSwimLava = fHeight > (m_bSwimLava ? fLavaHeight  + TWATER_ESCAPE : fLavaHeight) ? FALSE : TRUE;
	m_bInLava = fHeight > (m_bInLava ? fLavaHeight  + m_fBreathHeight : fLavaHeight + m_fBreathHeight) ? FALSE : TRUE;
