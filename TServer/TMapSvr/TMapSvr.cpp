...
BYTE CTMapSvrModule::Accept()
{
	...
	//LogEvent("SESSION INSERT %s, %d, UserID = %d \n", inet_ntoa(pPlayer->m_addr.sin_addr), m_mapSESSION.size(), pPlayer->m_dwID);
