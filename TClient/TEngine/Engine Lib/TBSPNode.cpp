						 ...
						 int& nLIGHT)
{
	...
	for( int i=0; i<nCount; i++)
	{
		...
		for( int j=1; j<INT(pWINDING->m_vPoint.size()) - 1; j++)
		{
	...
	for( int i = 0; i<nCount; i++)
	{
		...
		for( int j=0; j<nWINDING; j++)
		{
			...
			for( int k=1; k<INT(pWinding->m_vPoint.size()) - 1; k++)
			{
