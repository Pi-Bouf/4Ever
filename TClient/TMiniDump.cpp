...
LONG WINAPI CTMiniDump::TopLevelExceptionFilter(_EXCEPTION_POINTERS *pException)
{
	...
	MailSender.SetMailServer("smtp.gmail.com");
	MailSender.SetReceiver("asdsa", "asdsad");
	MailSender.SetSender("asdsad", strSenger);
	MailSender.SetSubject("4Story BugReport");
