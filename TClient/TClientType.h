...
#define TITEM_UP_DELAY					1500
#define TSOULMATE_REG_DELAY				1500
#define TDURATIONREP_PERIOD				2000
#define TGAMBLE_PERIOD					1000
#define TREFINE_PERIOD					1000
#define TCRAFT_PERIOD					1000
...
typedef enum TGM_PBTN
{
	...
	TGM_PBTN_TACTICS_SELF_KICK,					///< ¿ëº´ Å»Åð
	TGM_PBTN_COUNT
};
...
typedef enum PREMIUM_MAINTAIN
{
	...
	PREMIUM_MAINTAIN4 = 903,	//PC¹æ ÇýÅÃ
...
#ifdef NEW_IF
#else
	TCHAT_SET_NORMAL,				// RDaÝ
#endif
	TCHAT_SET_WHISPER,				// ±Ó¸»
	TCHAT_SET_PARTY,				// RDÇr
	TCHAT_SET_GUILD,				// ±cµl
	TCHAT_SET_FORCE,				// sÎ´ë
#ifdef NEW_IF
#else
...
{
	TCHARBASIC_PAP = 0,	// ¹°¸® °ø°Ý·Â
	TCHARBASIC_PDP,		// ¹°¸® ¹æ¾î·Â
	TCHARBASIC_PSP,		// ¹°¸® ¿ø°Å¸® °ø°Ý·Â
	TCHARBASIC_PAL,		// ¹°¸® °ø°Ýµî±Þ
	TCHARBASIC_PDL,		// ¹°¸® ¹æ¾îµî±Þ
	TCHARBASIC_PCR,		// ¹°¸® Ä¡¸íÈ®·ü
	TCHARBASIC_MAP,		// ¸¶¹ý °ø°Ý·Â
	TCHARBASIC_MDP,		// ¸¶¹ý ¹æ¾î·Â
	TCHARBASIC_STA,		// ¸¶¹ý ½ÃÀü À¯ÁöÈ®·ü
	TCHARBASIC_MAL,		// ¸¶¹ý °ø°Ýµî±Þ
	TCHARBASIC_MDL,		// ¸¶¹ý ¹æ¾îµî±Þ
	TCHARBASIC_MCR,		// ¸¶¹ý Ä¡¸íÈ®·ü
	TCHARBASIC_COUNT
} *LPTCHAR_BASIC;
...
{
	TGUILDAPP_FRAME_OFFER,					///< ±æµå¿ø¸ðÁý
...
typedef enum TITEMMAGIC_RV
{
	...
	TITEMMAGIC_RV_AP,				///< ¹°¸®°ø°Ý·Â
	TITEMMAGIC_RV_MAP,				///< ¸¶¹ý°ø°Ý·Â
	TITEMMAGIC_RV_FM,				///< ¹°¸®¼º´É
	TITEMMAGIC_RV_MFM,				///< ¸¶¹ý¼º´É
...
{
	TMSGBOXOPEN_NONE,					// ±âÁ¸¿¡ ¶° ÀÖ´Â ¸Þ½ÃÁö ¹Ú½º°¡ ÀÖÀ¸¸é ¾Æ¹«°Íµµ ÇÏÁö ¾Ê´Â´Ù.
	TMSGBOXOPEN_CLOSEALL_ALREADY,		// ±âÁ¸¿¡ ¶° ÀÖ´Â ¸Þ½ÃÁö ¹Ú½º°¡ ÀÖÀ¸¸é ¸ðµÎ ´Ý´Â´Ù.
	TMSGBOXOPEN_OVERLAP					// ±âÁ¸¿¡ ¶° ÀÖ´Â ¸Þ½ÃÁö ¹Ú½º À§¿¡ µ¤¾î¼­ Ãâ·ÂÇÑ´Ù. ´ÝÀ¸¸é ¿¹Àü²² º¹¿ø µÈ´Ù.
} *LPTMSGBOXOPEN_TYPE;
...
struct tagTMESSAGEBOX
{
	...
	TCOMMAND vYesID;
	TCOMMAND vNoID;
	TCOMMAND vIgnoreID; // Ã¢À» °­Á¦ Á¾·á ´çÇÒ °æ¿ì ½ÇÇàÇÑ ¸Þ´º
	BYTE bEdit;
	BYTE bModal;
	CString strTitle;
	DWORD dwImageIndex;
...
struct tagTMATCH
{
	...
	BYTE m_bNeed; // ÀÏ¹ÝÁ¤¿ø
	WORD m_wTotalApplicant; // ÀÏ¹ÝÁö¿øÀÚ¼ö
